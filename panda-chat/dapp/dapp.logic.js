...
DCLib.defineDAppLogic(process.env.DAPP_SLUG, function (payChannel) {
  ...
  var Roll = function (userBet, userNum, random_hash) {
	...
	console.log("qqqqqqqqqqqqQQQQQQQQQQQQQQQQQQQQQQQQQQqqqqqqq "+ userBet +" qq "+userNum);
